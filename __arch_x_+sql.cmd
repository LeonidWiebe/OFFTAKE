...
c:\progra~1\winrar\rar a -ac -x.\Offtsql\.git -x.\Offtsql\arch -x.\Offtsql\bin -x.\Offtsql\doc -x.\Offtsql\ext -x.\Offtsql\ico -x*.rar -x*.exe -agyyyy-mm-dd_hh-mm .\Offtsql_ .\Offtsql
pause
